...
public class Sleeper32_GridviewAdapterUp extends ArrayAdapter<Item>
{
    ...
    public Sleeper32_GridviewAdapterUp(Context context, int layoutResourceId, ArrayList<Item> data)
    {
