...
public class ThreeContact_Activity extends Activity implements OnItemSelectedListener {
    ...
    final String TAG = "ThreeContact.java";

    String name_s, email_s, phone_s, age_s, gender_s, item_s, name2_s, age2_s, item_s2, name3_s, age3_s, item_s3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contineu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (email_s.isEmpty() || phone_s.isEmpty() || name_s.isEmpty() || age_s.isEmpty() || name2_s.isEmpty() || age2_s.isEmpty() || name3_s.isEmpty() || age3_s.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "All the fields are mandatory", Toast.LENGTH_SHORT).show();
                } else {
                    Intent in = new Intent(ThreeContact_Activity.this, Conform_Booking.class);
