...
public class SixContact_Activity extends Activity implements OnItemSelectedListener {
    ...
    final String TAG = "SixContact.java";

    String name_s, email_s, phone_s, age_s, gender_s, item_s, name2_s, age2_s, item_s2, name3_s, age3_s, item_s3, name4_s, age4_s, item_s4, name5_s, age5_s, item_s5, name6_s, age6_s, item_s6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_six_contact);
        ...
        TextView fixseatno = (TextView) findViewById(R.id.fixseatno);

        fixseatno.setText("SeatNo:" + seats.get(4));

        TextView sixseatno = (TextView) findViewById(R.id.sixseatno);

        sixseatno.setText("SeatNo:" + seats.get(5));
        ...
        Spinner fix = (Spinner) findViewById(R.id.spinner6);

        Spinner six = (Spinner) findViewById(R.id.spinner7);
        ...
        //fix co passenger gender

        fix.setOnItemSelectedListener(this);
        ...
        for (int i = 0; i < ladies.size(); i++) {
            ...
            if (ladies.get(i).equalsIgnoreCase(seats.get(4))) {

                categories5.add("Female");

                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, categories5);

                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

                fix.setAdapter(dataAdapter);
        ...
        //six co passenger gender

        six.setOnItemSelectedListener(this);
        ...
        for (int i = 0; i < ladies.size(); i++) {
            ...
            if (ladies.get(i).equalsIgnoreCase(seats.get(5))) {

                categories6.add("Female");

                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, categories6);

                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

                six.setAdapter(dataAdapter);
        ...
        contineu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                EditText name_5 = (EditText) findViewById(R.id.fifthname);

                EditText age_5 = (EditText) findViewById(R.id.fifthage);

                EditText name_6 = (EditText) findViewById(R.id.sixthname);

                EditText age_6 = (EditText) findViewById(R.id.sixthage);
                ...
                Log.e(TAG, name_5.getText().toString());

                Log.e(TAG, age_5.getText().toString());

                Log.e(TAG, name_6.getText().toString());

                Log.e(TAG, age_6.getText().toString());
                ...
                Log.e(TAG, seats.get(4));

                Log.e(TAG, seats.get(5));
                ...
                name5_s = name_5.getText().toString();

                age5_s = age_5.getText().toString();

                name6_s = name_6.getText().toString();

                age6_s = age_6.getText().toString();


                if (email_s.isEmpty() || phone_s.isEmpty() || name_s.isEmpty() || age_s.isEmpty() || name2_s.isEmpty() || age2_s.isEmpty() || name3_s.isEmpty() || age3_s.isEmpty() || name4_s.isEmpty() || age4_s.isEmpty() || name5_s.isEmpty() || age5_s.isEmpty() || name6_s.isEmpty() || age6_s.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "All the fields are mandatory", Toast.LENGTH_SHORT).show();
                } else {
                    Intent in = new Intent(SixContact_Activity.this, Conform_Booking.class);
                    ...
                    in.putExtra("name5", name5_s);
                    in.putExtra("age5", age5_s);
                    AppConfig.name5 = name5_s;
                    AppConfig.age5 = age5_s;

                    in.putExtra("name6", name6_s);
                    in.putExtra("age6", age6_s);
                    AppConfig.name6 = name6_s;
                    AppConfig.age6 = age6_s;
                    ...
                    in.putExtra("gender5", item_s5);
                    in.putExtra("gender6", item_s6);
                    AppConfig.gender = item_s;
                    AppConfig.gender2 = item_s2;
                    AppConfig.gender3 = item_s3;
                    AppConfig.gender4 = item_s4;
                    AppConfig.gender5 = item_s5;
                    AppConfig.gender6 = item_s6;
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position,
        ...
        switch (parent.getId()) {
            ...
            case R.id.spinner5:
                ...
                break;
            case R.id.spinner6:
                item_s5 = parent.getItemAtPosition(position).toString();
                break;
            case R.id.spinner7:
                item_s6 = parent.getItemAtPosition(position).toString();
                break;
