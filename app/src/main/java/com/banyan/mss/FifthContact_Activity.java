...
public class FifthContact_Activity extends Activity implements OnItemSelectedListener {
    ...
    final String TAG = "FifthContact.java";

    String name_s, email_s, phone_s, age_s, gender_s, item_s, name2_s, age2_s, item_s2, name3_s, age3_s, item_s3, name4_s, age4_s, item_s4, name5_s, age5_s, item_s5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifth_contact);
        ...
        contineu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (email_s.isEmpty() || phone_s.isEmpty() || name_s.isEmpty() || age_s.isEmpty() || name2_s.isEmpty() || age2_s.isEmpty() || name3_s.isEmpty() || age3_s.isEmpty() || name4_s.isEmpty() || age4_s.isEmpty() || name5_s.isEmpty() || age5_s.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "All the fields are mandatory", Toast.LENGTH_SHORT).show();
                } else {
                    Intent in = new Intent(FifthContact_Activity.this, Conform_Booking.class);
